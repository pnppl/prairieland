[text (md)] · PDF: [screen] · [print]
  ...
  [text (md)]: i-dont-bash-back-i-shoot-first.md
  [screen]: i-dont-bash-back-i-shoot-first.pdf
  [print]: i-dont-bash-back-i-shoot-first_print-letter.pdf
...
*\*Vengeance 1-3 \*Interview with the Class Warriors*
