[text (md)] · PDF: [screen] · [print]
  ...
  [text (md)]: if-we-go-we-go-on-fire.md
  [screen]: if-we-go-we-go-on-fire.pdf
  [print]: if-we-go-we-go-on-fire_print-letter.pdf
...
[Long Leaf Distro]
  ...
  [Long Leaf Distro]: https://cryptpad.fr/file/#/2/file/TL%2Bc4k1QFDYSun8npyKkoXkm/
